...
|-----------|----------------|
| `use Joomla\CMS\Application\CMSApplicationInterface;` | ![All](https://img.shields.io/badge/All-purple?style=flat-square) |
...
Simply use this JPK:
```
Joomla---a6ee04f5_33c7_4a9b_aa6d_6a03f3715a88---Power
```
