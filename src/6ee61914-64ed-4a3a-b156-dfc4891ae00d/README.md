...
|-----------|----------------|
| `use Joomla\CMS\Event\Content\ContentPrepareEvent;` | ![All](https://img.shields.io/badge/All-purple?style=flat-square) |
...
Simply use this JPK:
```
Joomla---6ee61914_64ed_4a3a_b156_dfc4891ae00d---Power
```
