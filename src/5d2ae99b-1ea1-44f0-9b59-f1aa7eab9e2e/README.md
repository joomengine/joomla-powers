...
|-----------|----------------|
| `use Joomla\CMS\Toolbar\ToolbarFactoryInterface;` | ![All](https://img.shields.io/badge/All-purple?style=flat-square) |
| `use Error/Not/For/Joomla/Threeeeee;` | ![Joomla 3](https://img.shields.io/badge/Joomla 3-blue?style=flat-square) |
...
Simply use this JPK:
```
Joomla---5d2ae99b_1ea1_44f0_9b59_f1aa7eab9e2e---Power
```
