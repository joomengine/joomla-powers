...
|-----------|----------------|
| `use Joomla\CMS\Event\Content\AfterDisplayEvent;` | ![All](https://img.shields.io/badge/All-purple?style=flat-square) |
...
Simply use this JPK:
```
Joomla---a42c4e8e_ead1_442d_8b9a_99236a1ee9a9---Power
```
