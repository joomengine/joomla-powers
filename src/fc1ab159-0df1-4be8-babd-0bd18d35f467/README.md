...
|-----------|----------------|
| `use Joomla\CMS\Event\Content\BeforeDisplayEvent;` | ![All](https://img.shields.io/badge/All-purple?style=flat-square) |
...
Simply use this JPK:
```
Joomla---fc1ab159_0df1_4be8_babd_0bd18d35f467---Power
```
