...
|-----------|----------------|
| `use Joomla\CMS\Event\Content\AfterTitleEvent;` | ![All](https://img.shields.io/badge/All-purple?style=flat-square) |
...
Simply use this JPK:
```
Joomla---fa9c1320_a115_452a_a0a8_534fcdea490b---Power
```
