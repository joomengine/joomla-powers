...
|-----------|----------------|
| `use Joomla\CMS\Mail\MailerFactoryInterface;` | ![All](https://img.shields.io/badge/All-purple?style=flat-square) |
...
Simply use this JPK:
```
Joomla---3e2779e9_b33f_42b8_a13b_53f08d99f15b---Power
```
